module @compiled_scheduler {
  func.func @run_initialize(%arg0: !torch.vtensor<[1,4,120,128],f16>) -> (!torch.vtensor<[1,4,120,128],f16>, !torch.vtensor<[2,6],f16>, !torch.vtensor<[],si64>, !torch.vtensor<[10],f32>) attributes {iree.reflection = {input_dtypes = "['float16']", input_shapes = "[(1, 4, 120, 128)]", model_name = "stabilityai/stable-diffusion-xl-base-1.0_EulerDiscrete_scheduler_10"}, torch.assume_strict_symbolic_shapes} {
    %0 = torch.vtensor.literal(dense_resource<torch_tensor_10_torch.float32> : tensor<10xf32>) : !torch.vtensor<[10],f32>
    %1 = torch.vtensor.literal(dense_resource<torch_tensor_11_torch.float32> : tensor<11xf32>) : !torch.vtensor<[11],f32>
    %2 = torch.vtensor.literal(dense_resource<torch_tensor_1_6_torch.float16> : tensor<1x6xf16>) : !torch.vtensor<[1,6],f16>
    %3 = torch.vtensor.literal(dense<10> : tensor<si64>) : !torch.vtensor<[],si64>
    ...
    %16 = torch.aten.max %1 : !torch.vtensor<[11],f32> -> !torch.vtensor<[],f32>
    ...
    %20 = torch.aten.mul.Tensor %arg0, %19 : !torch.vtensor<[1,4,120,128],f16>, !torch.vtensor<[],f32> -> !torch.vtensor<[1,4,120,128],f16>
    return %20, %11, %15, %0 : !torch.vtensor<[1,4,120,128],f16>, !torch.vtensor<[2,6],f16>, !torch.vtensor<[],si64>, !torch.vtensor<[10],f32>
  }
  func.func @run_scale(%arg0: !torch.vtensor<[1,4,120,128],f16>, %arg1: !torch.vtensor<[1],si64>, %arg2: !torch.vtensor<[?],f32>) -> (!torch.vtensor<[1,4,120,128],f16>, !torch.vtensor<[1],f16>) attributes {iree.reflection = {input_dtypes = "['float16', 'int64', 'float32']", input_shapes = "[(1, 4, 120, 128), (1,), ('?',)]", model_name = "stabilityai/stable-diffusion-xl-base-1.0_EulerDiscrete_scheduler_10"}, torch.assume_strict_symbolic_shapes} {
    %0 = torch.vtensor.literal(dense_resource<torch_tensor_10_torch.float32> : tensor<10xf32>) : !torch.vtensor<[10],f32>
    %1 = torch.vtensor.literal(dense_resource<torch_tensor_11_torch.float32> : tensor<11xf32>) : !torch.vtensor<[11],f32>
    ...
    %5 = torch.aten.eq.Tensor %0, %4 : !torch.vtensor<[10],f32>, !torch.vtensor<[1],f32> -> !torch.vtensor<[10],i1>
    %int3 = torch.constant.int 3
    %6 = torch.prims.convert_element_type %5, %int3 : !torch.vtensor<[10],i1>, !torch.int -> !torch.vtensor<[10],si32>
    %none = torch.constant.none
    %false = torch.constant.bool false
    %7 = torch.aten.argmax %6, %none, %false : !torch.vtensor<[10],si32>, !torch.none, !torch.bool -> !torch.vtensor<[],si64>
    %int0 = torch.constant.int 0
    ...
    %17 = torch.aten.index.Tensor %1, %16 : !torch.vtensor<[11],f32>, !torch.list<optional<vtensor>> -> !torch.vtensor<[1],f32>
    %int2 = torch.constant.int 2
    ...
    %21 = torch.aten.div.Tensor %arg0, %20 : !torch.vtensor<[1,4,120,128],f16>, !torch.vtensor<[1],f32> -> !torch.vtensor<[1,4,120,128],f32>
    %int5 = torch.constant.int 5
    %22 = torch.prims.convert_element_type %21, %int5 : !torch.vtensor<[1,4,120,128],f32>, !torch.int -> !torch.vtensor<[1,4,120,128],f16>
    ...
    return %22, %23 : !torch.vtensor<[1,4,120,128],f16>, !torch.vtensor<[1],f16>
  }
  func.func @run_step(%arg0: !torch.vtensor<[1,4,120,128],f16>, %arg1: !torch.vtensor<[1],f16>, %arg2: !torch.vtensor<[1,4,120,128],f16>) -> !torch.vtensor<[1,4,120,128],f16> attributes {iree.reflection = {input_dtypes = "['float16', 'float16', 'float16']", input_shapes = "[(1, 4, 120, 128), (1,), (1, 4, 120, 128)]", model_name = "stabilityai/stable-diffusion-xl-base-1.0_EulerDiscrete_scheduler_10"}, torch.assume_strict_symbolic_shapes} {
    %0 = torch.vtensor.literal(dense_resource<torch_tensor_10_torch.float32> : tensor<10xf32>) : !torch.vtensor<[10],f32>
    %1 = torch.vtensor.literal(dense_resource<torch_tensor_11_torch.float32> : tensor<11xf32>) : !torch.vtensor<[11],f32>
    ...
    %5 = torch.aten.eq.Tensor %0, %arg1 : !torch.vtensor<[10],f32>, !torch.vtensor<[1],f16> -> !torch.vtensor<[10],i1>
    %int3 = torch.constant.int 3
    %6 = torch.prims.convert_element_type %5, %int3 : !torch.vtensor<[10],i1>, !torch.int -> !torch.vtensor<[10],si32>
    %none = torch.constant.none
    %false = torch.constant.bool false
    ...
    %15 = torch.aten.index_select %8, %int0_14, %14 : !torch.vtensor<[1],si64>, !torch.int, !torch.vtensor<[1],si64> -> !torch.vtensor<[1],si64>
    %int6 = torch.constant.int 6
    %16 = torch.prims.convert_element_type %arg2, %int6 : !torch.vtensor<[1,4,120,128],f16>, !torch.int -> !torch.vtensor<[1,4,120,128],f32>
    %int0_15 = torch.constant.int 0
    %17 = torch.aten.index_select %1, %int0_15, %15 : !torch.vtensor<[11],f32>, !torch.int, !torch.vtensor<[1],si64> -> !torch.vtensor<[1],f32>
    ...
    %35 = torch.prim.ListConstruct %int1_19, %int4_20, %int120, %int128 : (!torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    ...
    %36 = torch.aten.randn.generator %35, %none_21, %int5, %int0_22, %cpu_23, %false_24 : !torch.list<int>, !torch.none, !torch.int, !torch.int, !torch.Device, !torch.bool -> !torch.vtensor<[1,4,120,128],f16>
    %int5_25 = torch.constant.int 5
    %37 = torch.prims.convert_element_type %36, %int5_25 : !torch.vtensor<[1,4,120,128],f16>, !torch.int -> !torch.vtensor<[1,4,120,128],f16>
    %float1.000000e00 = torch.constant.float 1.000000e+00
    %38 = torch.aten.mul.Scalar %37, %float1.000000e00 : !torch.vtensor<[1,4,120,128],f16>, !torch.float -> !torch.vtensor<[1,4,120,128],f16>
    %int1_26 = torch.constant.int 1
    %int1_27 = torch.constant.int 1
    %39 = torch.aten.add.Scalar %34, %int1_26, %int1_27 : !torch.vtensor<[1],f32>, !torch.int, !torch.int -> !torch.vtensor<[1],f32>
    %40 = torch.aten.mul.Tensor %17, %39 : !torch.vtensor<[1],f32>, !torch.vtensor<[1],f32> -> !torch.vtensor<[1],f32>
    %int0_28 = torch.constant.int 0
    %41 = torch.aten.gt.Scalar %34, %int0_28 : !torch.vtensor<[1],f32>, !torch.int -> !torch.vtensor<[1],i1>
    %int2 = torch.constant.int 2
    %42 = torch.aten.pow.Tensor_Scalar %40, %int2 : !torch.vtensor<[1],f32>, !torch.int -> !torch.vtensor<[1],f32>
    %int2_29 = torch.constant.int 2
    %43 = torch.aten.pow.Tensor_Scalar %17, %int2_29 : !torch.vtensor<[1],f32>, !torch.int -> !torch.vtensor<[1],f32>
    %int1_30 = torch.constant.int 1
    %44 = torch.aten.sub.Tensor %42, %43, %int1_30 : !torch.vtensor<[1],f32>, !torch.vtensor<[1],f32>, !torch.int -> !torch.vtensor<[1],f32>
    %float5.000000e-01 = torch.constant.float 5.000000e-01
    %45 = torch.aten.pow.Tensor_Scalar %44, %float5.000000e-01 : !torch.vtensor<[1],f32>, !torch.float -> !torch.vtensor<[1],f32>
    %46 = torch.aten.mul.Tensor %38, %45 : !torch.vtensor<[1,4,120,128],f16>, !torch.vtensor<[1],f32> -> !torch.vtensor<[1,4,120,128],f32>
    %int1_31 = torch.constant.int 1
    %47 = torch.aten.add.Tensor %16, %46, %int1_31 : !torch.vtensor<[1,4,120,128],f32>, !torch.vtensor<[1,4,120,128],f32>, !torch.int -> !torch.vtensor<[1,4,120,128],f32>
    %48 = torch.aten.where.self %41, %47, %16 : !torch.vtensor<[1],i1>, !torch.vtensor<[1,4,120,128],f32>, !torch.vtensor<[1,4,120,128],f32> -> !torch.vtensor<[1,4,120,128],f32>
    %49 = torch.aten.mul.Tensor %40, %arg0 : !torch.vtensor<[1],f32>, !torch.vtensor<[1,4,120,128],f16> -> !torch.vtensor<[1,4,120,128],f32>
    %int1_32 = torch.constant.int 1
    %50 = torch.aten.sub.Tensor %48, %49, %int1_32 : !torch.vtensor<[1,4,120,128],f32>, !torch.vtensor<[1,4,120,128],f32>, !torch.int -> !torch.vtensor<[1,4,120,128],f32>
    %int1_33 = torch.constant.int 1
    %51 = torch.aten.sub.Tensor %48, %50, %int1_33 : !torch.vtensor<[1,4,120,128],f32>, !torch.vtensor<[1,4,120,128],f32>, !torch.int -> !torch.vtensor<[1,4,120,128],f32>
    %52 = torch.aten.div.Tensor %51, %40 : !torch.vtensor<[1,4,120,128],f32>, !torch.vtensor<[1],f32> -> !torch.vtensor<[1,4,120,128],f32>
    %int1_34 = torch.constant.int 1
    %int1_35 = torch.constant.int 1
    %53 = torch.aten.add.Scalar %15, %int1_34, %int1_35 : !torch.vtensor<[1],si64>, !torch.int, !torch.int -> !torch.vtensor<[1],si64>
    %54 = torch.prim.ListConstruct %53 : (!torch.vtensor<[1],si64>) -> !torch.list<optional<vtensor>>
    %55 = torch.aten.index.Tensor %1, %54 : !torch.vtensor<[11],f32>, !torch.list<optional<vtensor>> -> !torch.vtensor<[1],f32>
    %int1_36 = torch.constant.int 1
    %56 = torch.aten.sub.Tensor %55, %40, %int1_36 : !torch.vtensor<[1],f32>, !torch.vtensor<[1],f32>, !torch.int -> !torch.vtensor<[1],f32>
    %57 = torch.aten.mul.Tensor %52, %56 : !torch.vtensor<[1,4,120,128],f32>, !torch.vtensor<[1],f32> -> !torch.vtensor<[1,4,120,128],f32>
    %int1_37 = torch.constant.int 1
    %58 = torch.aten.add.Tensor %48, %57, %int1_37 : !torch.vtensor<[1,4,120,128],f32>, !torch.vtensor<[1,4,120,128],f32>, !torch.int -> !torch.vtensor<[1,4,120,128],f32>
    %int5_38 = torch.constant.int 5
    %59 = torch.prims.convert_element_type %58, %int5_38 : !torch.vtensor<[1,4,120,128],f32>, !torch.int -> !torch.vtensor<[1,4,120,128],f16>
    return %59 : !torch.vtensor<[1,4,120,128],f16>
  }
}
...
{-#
  dialect_resources: {
    builtin: {
      torch_tensor_10_torch.float32: "0x04000000004061440040484400402F44004016440080FA430080C84300809643000049430000CA420000803F",
      torch_tensor_11_torch.float32: "0x0400000041400641474DA440C841564022BE12402CD5CF3F1E88953F5FED553FFEF4123F763FB13E5F39293D00000000",
      torch_tensor_1_6_torch.float16: "0x02000000806300640000000080630064"
    }
  }
#-}
