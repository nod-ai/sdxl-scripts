...
module attributes {transform.with_named_sequence} {
  ...
  util.func private @conv_entry_point_k1(%arg0: tensor<2x34x34x1280xf16>, %arg1: tensor<3x3x1280x1280xf16>)
    ...
    %5 = hal.dispatch.extern "igemm_fwd_gtcx3_nhwc_fp16_bx0_ex1_bt128x256x32_wt32x32x8_ws1x2_wr2x2_ta1x8x2x1_1x4x1x64_tb1x8x4x1_1x4x1x64_gkgs"(%hi, %wi, %n,
        %k, %c, %ho, %wo, %stride_h, %stride_w, %dilation_h, %dilation_w, %pad_h, %pad_w, %y, %x, %group, 
        %arg0, %wei_tr) : (i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32,
        tensor<2x34x34x1280xf16>, tensor<1280x3x3x1280xf16>) -> tensor<2x32x32x1280xf16>
      count(%device: !hal.device) -> (index, index, index) {
        %c1_0 = arith.constant 1 : index
        %c1280_0 = arith.constant 640 : index
      ...
      objects({
        #rocm_target ordinal(0) = [
          #hal.executable.object<{
            path = "/home/nmeganat/sdxl-scripts/igemm_fwd_gtc_gfx940_nhwc_fp16.hsaco"
          }>
        ]
      })
  ...
  util.func private @conv_entry_point_k2(%arg0: tensor<2x34x34x1280xf16>, %arg1: tensor<3x3x1280x2560xf16>) 
    ...
    %wei_empty = tensor.empty() : tensor<2560x3x3x1280xf16>
    %wei_tr = linalg.transpose ins(%arg1: tensor<3x3x1280x2560xf16>) outs(%wei_empty : tensor<2560x3x3x1280xf16>) permutation = [3, 0, 1, 2] 
    %hi = arith.constant 34 : i32
    %wi = arith.constant 34 : i32
    %n = arith.constant 2 : i32
    %c = arith.constant 1280 : i32
    ...
    %5 = hal.dispatch.extern "igemm_fwd_gtcx3_nhwc_fp16_bx0_ex1_bt256x128x32_wt32x32x8_ws2x1_wr2x2_ta1x8x4x1_1x4x1x64_tb1x8x2x1_1x4x1x64_gkgs"(%hi, %wi, %n,
        %k, %c, %ho, %wo, %stride_h, %stride_w, %dilation_h, %dilation_w, %pad_h, %pad_w, %y, %x, %group, 
        %arg0, %wei_tr) : (i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32,
        tensor<2x34x34x1280xf16>, tensor<2560x3x3x1280xf16>) -> tensor<2x32x32x2560xf16>
      count(%device: !hal.device) -> (index, index, index) {
        %c1_0 = arith.constant 1 : index
        %c1280_0 = arith.constant 1280 : index
        hal.return %c1280_0, %c1_0, %c1_0 : index, index, index
      }
      layout(#hal.pipeline.layout<push_constants = 16, sets = [
        <0, bindings = [
      ...
      objects({
        #rocm_target ordinal(0) = [
          #hal.executable.object<{
            path = "/home/nmeganat/magnum_opus/igemm_fwd_gtc_gfx940_nhwc_fp16.hsaco"
          }>
        ]
      })
      attributes {subgroupSize = 64, workgroup_size = [256 : index, 1 : index, 1 : index]}
  ...
  transform.named_sequence @match_conv_k2(
    ...
    %ins, %outs = transform.iree.match.cast_compatible_dag_from_root %root {
      ^bb0(%lhs: tensor<2x34x34x1280xf16>, %rhs: tensor<3x3x1280x2560xf16>):
        ...
        %87 = linalg.fill {"match.operation_name_only"} ins(%cst_31 : f32) outs(%84 : tensor<2x32x32x2560xf32>) -> tensor<2x32x32x2560xf32>
    ...
    %wei_empty = tensor.empty() : tensor<640x3x3x640xf16>
    %wei_tr = linalg.transpose ins(%arg1: tensor<3x3x640x640xf16>) outs(%wei_empty : tensor<640x3x3x640xf16>) permutation = [3, 0, 1, 2] 
    ...
    %5 = hal.dispatch.extern "igemm_fwd_gtcx3_nhwc_fp16_bx0_ex1_bt256x128x32_wt32x32x8_ws2x1_wr2x2_ta1x8x4x1_1x4x1x64_tb1x8x2x1_1x4x1x64_gkgs"(%hi, %wi, %n,
        %k, %c, %ho, %wo, %stride_h, %stride_w, %dilation_h, %dilation_w, %pad_h, %pad_w, %y, %x, %group, 
        %arg0, %wei_tr) : (i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32,
        tensor<2x66x66x640xf16>, tensor<640x3x3x640xf16>) -> tensor<2x64x64x640xf16>
      count(%device: !hal.device) -> (index, index, index) {
        %c1_0 = arith.constant 1 : index
        %c1280_0 = arith.constant 1280 : index
        hal.return %c1280_0, %c1_0, %c1_0 : index, index, index
  ...
  transform.named_sequence @match_conv_k3(
    ...
    %ins, %outs = transform.iree.match.cast_compatible_dag_from_root %root {
      ^bb0(%lhs: tensor<2x66x66x640xf16>, %rhs: tensor<3x3x640x640xf16>):
        ...
        %87 = linalg.fill {"match.operation_name_only"} ins(%cst_31 : f32) outs(%84 : tensor<2x64x64x640xf32>) -> tensor<2x64x64x640xf32>
  ...
  util.func private @conv_entry_point_k4(%arg0: tensor<2x34x34x640xf16>, %arg1: tensor<3x3x640x640xf16>) 
    ...
    %5 = hal.dispatch.extern "igemm_fwd_gtcx3_nhwc_fp16_bx0_ex1_bt256x128x32_wt32x32x8_ws2x1_wr2x2_ta1x8x4x1_1x4x1x64_tb1x8x2x1_1x4x1x64_gkgs"(%hi, %wi, %n,
        %k, %c, %ho, %wo, %stride_h, %stride_w, %dilation_h, %dilation_w, %pad_h, %pad_w, %y, %x, %group, 
        %arg0, %wei_tr) : (i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32,
        tensor<2x34x34x640xf16>, tensor<640x3x3x640xf16>) -> tensor<2x32x32x640xf16>
      count(%device: !hal.device) -> (index, index, index) {
        %c1_0 = arith.constant 1 : index
        %c1280_0 = arith.constant 160 : index
        hal.return %c1280_0, %c1_0, %c1_0 : index, index, index
      }
      layout(#hal.pipeline.layout<push_constants = 16, sets = [
        <0, bindings = [
  ...
  transform.named_sequence @match_conv_k4(
    ...
    %ins, %outs = transform.iree.match.cast_compatible_dag_from_root %root {
      ^bb0(%lhs: tensor<2x34x34x640xf16>, %rhs: tensor<3x3x640x640xf16>):
        ...
        %87 = linalg.fill {"match.operation_name_only"} ins(%cst_31 : f32) outs(%84 : tensor<2x32x32x640xf32>) -> tensor<2x32x32x640xf32>
  ...
  util.func private @conv_entry_point_k5(%arg0: tensor<2x66x66x1280xf16>, %arg1: tensor<3x3x1280x1280xf16>) 
    ...
    %5 = hal.dispatch.extern "igemm_fwd_gtcx3_nhwc_fp16_bx0_ex1_bt256x128x32_wt32x32x8_ws2x1_wr2x2_ta1x8x4x1_1x4x1x64_tb1x8x2x1_1x4x1x64_gkgs"(%hi, %wi, %n,
        %k, %c, %ho, %wo, %stride_h, %stride_w, %dilation_h, %dilation_w, %pad_h, %pad_w, %y, %x, %group, 
        %arg0, %wei_tr) : (i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32,
        tensor<2x66x66x1280xf16>, tensor<1280x3x3x1280xf16>) -> tensor<2x64x64x1280xf16>
      count(%device: !hal.device) -> (index, index, index) {
        %c1_0 = arith.constant 1 : index
  ...
  transform.named_sequence @match_conv_k5(
    ...
    %ins, %outs = transform.iree.match.cast_compatible_dag_from_root %root {
      ^bb0(%lhs: tensor<2x66x66x1280xf16>, %rhs: tensor<3x3x1280x1280xf16>):
        ...
        %87 = linalg.fill {"match.operation_name_only"} ins(%cst_31 : f32) outs(%84 : tensor<2x64x64x1280xf32>) -> tensor<2x64x64x1280xf32>
  ...
  util.func private @conv_entry_point_k6(%arg0: tensor<2x130x130x320xf16>, %arg1: tensor<3x3x320x320xf16>) 
    ...
    %wei_empty = tensor.empty() : tensor<320x3x3x320xf16>
    %wei_tr = linalg.transpose ins(%arg1: tensor<3x3x320x320xf16>) outs(%wei_empty : tensor<320x3x3x320xf16>) permutation = [3, 0, 1, 2] 
    ...
    %5 = hal.dispatch.extern "igemm_fwd_gtcx3_nhwc_fp16_bx0_ex1_bt256x128x32_wt32x32x8_ws2x1_wr2x2_ta1x8x4x1_1x4x1x64_tb1x8x2x1_1x4x1x64_gkgs"(%hi, %wi, %n,
        %k, %c, %ho, %wo, %stride_h, %stride_w, %dilation_h, %dilation_w, %pad_h, %pad_w, %y, %x, %group, 
        %arg0, %wei_tr) : (i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32,
        tensor<2x130x130x320xf16>, tensor<320x3x3x320xf16>) -> tensor<2x128x128x320xf16>
      count(%device: !hal.device) -> (index, index, index) {
        %c1_0 = arith.constant 1 : index
        %c1280_0 = arith.constant 768 : index
        hal.return %c1280_0, %c1_0, %c1_0 : index, index, index
      }
      layout(#hal.pipeline.layout<push_constants = 16, sets = [
        <0, bindings = [
  ...
  transform.named_sequence @match_conv_k6(
    ...
    %ins, %outs = transform.iree.match.cast_compatible_dag_from_root %root {
      ^bb0(%lhs: tensor<2x130x130x320xf16>, %rhs: tensor<3x3x320x320xf16>):
        ...
        %87 = linalg.fill {"match.operation_name_only"} ins(%cst_31 : f32) outs(%84 : tensor<2x128x128x320xf32>) -> tensor<2x128x128x320xf32>
