...
iree-compile $PWD/base_ir/stable_diffusion_xl_base_1_0_PNDM_64_1024x1024_fp16_unet_30.mlir \
    ...
    --iree-hal-dump-executable-configurations-to=configurations/scheduled-unet-misa \
    --iree-hal-dump-executable-sources-to=sources/scheduled-unet-misa \
    --iree-hal-dump-executable-binaries-to=binaries/scheduled-unet-misa \
    --iree-hal-dump-executable-benchmarks-to=benchmarks/scheduled-unet-misa \
